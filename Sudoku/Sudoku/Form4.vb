Public Class Form4
    ...
    Private Sub Form4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        grid(6, 0).Text = "4"
        grid(6, 0).Enabled = False
        grid(7, 0).Text = "5"
        grid(7, 0).Enabled = False
        grid(0, 1).Text = "5"
        grid(0, 1).Enabled = False
        grid(2, 1).Text = "3"
        grid(2, 1).Enabled = False
        grid(3, 1).Text = "1"
        grid(3, 1).Enabled = False
        grid(4, 1).Text = "7"
        grid(4, 1).Enabled = False
        grid(6, 1).Text = "2"
        ...
        grid(2, 2).Text = "8"
        grid(2, 2).Enabled = False
        grid(5, 2).Text = "5"
        grid(5, 2).Enabled = False
        grid(0, 3).Text = "4"
        grid(0, 3).Enabled = False
        grid(1, 3).Text = "8"
        ...
        grid(2, 4).Text = "6"
        grid(2, 4).Enabled = False
        grid(4, 4).Text = "2"
        grid(4, 4).Enabled = False
        grid(5, 4).Text = "8"
        grid(5, 4).Enabled = False
        grid(7, 4).Text = "1"
        grid(7, 4).Enabled = False
        grid(8, 4).Text = "5"
        grid(8, 4).Enabled = False
        grid(0, 5).Text = "2"
        grid(0, 5).Enabled = False
        grid(4, 5).Text = "9"
        grid(4, 5).Enabled = False
        grid(5, 5).Text = "3"
        grid(5, 5).Enabled = False
        grid(0, 6).Text = "7"
        ...
        grid(8, 6).Text = "9"
        grid(8, 6).Enabled = False
        grid(0, 7).Text = "8"
        grid(0, 7).Enabled = False
        grid(2, 7).Text = "2"
        grid(2, 7).Enabled = False
        grid(5, 7).Text = "4"
        grid(5, 7).Enabled = False
        grid(6, 7).Text = "1"
        grid(6, 7).Enabled = False
        grid(2, 8).Text = "4"
        grid(2, 8).Enabled = False
        grid(3, 8).Text = "7"
        grid(3, 8).Enabled = False
        grid(7, 8).Text = "2"
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        'Puzzle: http://www.pdfpad.com/sudoku/pdf/e3598.pdf A
        'Answers: http://www.pdfpad.com/sudoku/pdf/e3598-k.pdf
        ...
        If choice = vbYes Then
            ...
            If grid(0, 0).Text = "1" And grid(1, 0).Text = "2" And grid(3, 0).Text = "8" And grid(4, 0).Text = "3" And grid(5, 0).Text = "6" And grid(8, 0).Text = "7" And grid(1, 1).Text = "4" And grid(5, 1).Text = "9" And grid(8, 1).Text = "8" And grid(0, 2).Text = "6" And grid(3, 2).Text = "2" And grid(4, 2).Text = "4" And grid(6, 2).Text = "9" And grid(7, 2).Text = "3" And grid(8, 2).Text = "1" And grid(2, 3).Text = "5" And grid(3, 3).Text = "6" And grid(4, 3).Text = "1" And grid(5, 3).Text = "7" And grid(7, 3).Text = "9" And grid(8, 3).Text = "2" And grid(1, 4).Text = "3" And grid(3, 4).Text = "4" And grid(6, 4).Text = "7" And grid(1, 5).Text = "1" And grid(2, 5).Text = "7" And grid(3, 5).Text = "5" And grid(6, 5).Text = "6" And grid(7, 5).Text = "8" And grid(8, 5).Text = "4" And grid(1, 6).Text = "6" And grid(2, 6).Text = "1" And grid(5, 6).Text = "2" And grid(6, 6).Text = "8" And grid(7, 6).Text = "4" And grid(1, 7).Text = "5" And grid(3, 7).Text = "9" And grid(4, 7).Text = "6" And grid(7, 7).Text = "7" And grid(8, 7).Text = "3" And grid(0, 8).Text = "3" And grid(1, 8).Text = "9" And grid(4, 8).Text = "8" And grid(5, 8).Text = "1" And grid(6, 8).Text = "5" Then
