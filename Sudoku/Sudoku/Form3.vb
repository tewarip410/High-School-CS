Public Class Form3
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        'Sudoku Puzzle: http://www.pdfpad.com/sudoku/pdf/e3648.pdf B
        ...
        If choice = vbYes Then
            ...
            If grid(1, 0).Text = "6" And grid(5, 0).Text = "5" And grid(6, 0).Text = "7" And grid(3, 1).Text = "8" And grid(4, 1).Text = "3" And grid(7, 1).Text = "4" And grid(8, 1).Text = "5" And grid(0, 2).Text = "5" And grid(1, 2).Text = "3" And grid(2, 2).Text = "8" And grid(3, 2).Text = "4" And grid(4, 2).Text = "7" And grid(5, 2).Text = "1" And grid(6, 2).Text = "9" And grid(7, 2).Text = "6" And grid(8, 2).Text = "2" And grid(0, 3).Text = "2" And grid(1, 3).Text = "1" And grid(2, 3).Text = "9" And grid(3, 3).Text = "6" And grid(4, 3).Text = "4" And grid(5, 3).Text = "7" And grid(6, 3).Text = "5" And grid(7, 3).Text = "3" And grid(8, 3).Text = "8" And grid(3, 4).Text = "1" And grid(4, 4).Text = "5" And grid(7, 4).Text = "9" And grid(8, 4).Text = "7" And grid(1, 5).Text = "5" And grid(5, 5).Text = "9" And grid(6, 5).Text = "6" And grid(1, 6).Text = "2" And grid(3, 6).Text = "9" And grid(5, 6).Text = "3" And grid(6, 6).Text = "8" And grid(8, 6).Text = "6" And grid(0, 7).Text = "3" And grid(2, 7).Text = "6" And grid(3, 7).Text = "7" And grid(4, 7).Text = "8" And grid(5, 7).Text = "2" And grid(6, 7).Text = "4" And grid(7, 7).Text = "5" And grid(8, 7).Text = "1" And grid(1, 8).Text = "8" And grid(3, 8).Text = "5" And grid(5, 8).Text = "4" And grid(6, 8).Text = "3" And grid(8, 8).Text = "9" Then
